...
public struct Diagnostic: Sendable, Hashable, Codable {
    ...
    public enum Severity: Sendable, Hashable, Comparable {
        case note
        /// Below warning — never fails CI, shown only in verbose mode.
        /// Used for opt-in advisories such as `potentialDuplicate`.
        case suggestion
        case warning
        case error
    }
...
extension Diagnostic.Severity: Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .suggestion: try c.encode("suggestion")
...
extension Diagnostic: CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .note:       "note"
        case .suggestion: "note"   // rendered as note in Xcode; never elevates to warning
